...
public class MainAppController {
    ...
    private void addTask() {
        try {
            ...
            Task task = new Task(
                titleField.getText(), priorityBox.getValue(),dueDatePicker.getValue(),"Incomplete"
            );
    ...
    private void deleteTask() {
        try {
            ...
            if (selected == null) {
                ...
                throw new TaskNotSelectedException("Pilih Data Untuk Dihapus!");
    ...
    private void markTaskComplete() {
        try {
            ...
            if (selected == null) {
                // TODO: Throw new TaskNotSelectedException dengan pesan yang sesuai
                throw new TaskNotSelectedException("Pilih Task yang Sesuai");
